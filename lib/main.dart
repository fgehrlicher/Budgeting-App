      ...
      ..addAll(
        [
          Transaction(
            ...
            date: DateTime.parse("2019-12-01 10:00:00"),
            amount: 280000,
            id: 1,
          ),
          Transaction(
            title: "Rent",
            date: DateTime.parse("2019-12-02 09:00:00"),
            amount: -120000,
            id: 2,
          ),
          Transaction(
            ...
            date: DateTime.parse("2019-12-05 15:00:00"),
            amount: -20000,
            id: 3,
          ),
          Transaction(
          ...
          Transaction(
            title: "Bar",
            date: DateTime.parse("2019-12-13 02:32:00"),
            amount: -7000,
            id: 6,
          ),
          Transaction(
            ...
            date: DateTime.parse("2019-12-20 12:00:00"),
            amount: -15000,
            id: 7,
          ),
          Transaction(
            title: "Water and Electricity",
            date: DateTime.parse("2019-12-23 12:00:00"),
            amount: -20000,
            id: 8,
          ),
          Transaction(
